...
#define BCM2837_GPFSEL0 (BCM2837_GPIO_BASE)
#define BCM2837_GPFSEL1 (BCM2837_GPIO_BASE + 0x04)
#define BCM2837_GPFSEL2 (BCM2837_GPIO_BASE + 0x08)
#define BCM2837_GPSET0 (BCM2837_GPIO_BASE + 0x1C)
#define BCM2837_GPCLR0 (BCM2837_GPIO_BASE + 0x28)
#define BCM2837_GPPUD (BCM2837_GPIO_BASE + 0x94)
#define BCM2837_GPPUDCLK0 (BCM2837_GPIO_BASE + 0x98)
...
#define BCM2837_PUT32(addr, value)        \
  do {                                    \
